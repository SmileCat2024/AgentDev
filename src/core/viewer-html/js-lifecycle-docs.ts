export const VIEWER_JS_LIFECYCLE_DOCS = `    const lifecycleDocs = {
      AgentInitiate: {
        ...
        body: {
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    boot: { lifecycle: "AgentInitiate", kind: "observe" },',
          '  };',
          '',
          '  async boot(ctx) {',
      ...
      AgentDestroy: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    cleanup: { lifecycle: "AgentDestroy", kind: "observe" },',
          '  };',
          '',
          '  async cleanup() {',
      ...
      CallStart: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    rewriteInput: { lifecycle: "CallStart", kind: "observe" },',
          '  };',
          '',
      ...
      CallFinish: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    afterCall: { lifecycle: "CallFinish", kind: "observe" },',
          '  };',
          '',
          '  async afterCall(ctx) {',
      ...
      StepStart: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    injectReminder: { lifecycle: "StepStart", kind: "observe" },',
          '  };',
          '',
      ...
      StepFinish: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    decide: { lifecycle: "StepFinish", kind: "guard", role: "advisor" },',
          '  };',
          '',
          '  async decide(ctx) {',
      ...
      ToolUse: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    guard: { lifecycle: "ToolUse", kind: "guard", role: "advisor" },',
          '  };',
          '',
          '  async guard(ctx) {',
      ...
      ToolFinished: {
        ...
        body: { zh: [
          ...
          'class MyFeature {',
          '  static hooks = {',
          '    record: { lifecycle: "ToolFinished", kind: "observe" },',
          '  };',
          '',
          '  async record(ctx) {',
